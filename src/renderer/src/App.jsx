...
const App = () => {
  ...
  const [selectedAudioItag, setSelectedAudioItag] = useState(null)
              ...
              <button
                onClick={async () => {
                  ...
                  if (!selectedVideoItag && !selectedAudioItag) {
                    ...
                    window.electron.ipcRenderer.once('download-reply', (event, arg) => {
                      setLoading(false)
                      if (arg === 'success') {
                        videoSuccess()
                      } else {
                  ...
                  if (selectedVideoItag && selectedAudioItag) {
                    ...
                    window.electron.ipcRenderer.once('download-custom-reply', (event, arg) => {
                      setLoading(false)
                      if (arg === 'success') {
                        videoSuccess()
                      } else {
